  ...
  actions: {
    ...
    async fetchStatus(indexerUrl){
      ...
      return fetch(url.href,  {
        ...
        body: JSON.stringify({query: "{ indexingStatuses { subgraph synced health entityCount fatalError{ message deterministic block{ number } } chains{ earliestBlock{number} latestBlock{number} chainHeadBlock{number} } } }"}),
