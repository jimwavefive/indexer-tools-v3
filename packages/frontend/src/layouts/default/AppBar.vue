<template>
  ...
  >
    ...
    <div style="overflow: hidden;white-space: nowrap;">
      ...
      <v-btn
          v-if="featureFlagStore.isEnabled('agent')"
          variant="text"
          to="/agent"
          class="ml-2 mr-2"
      >
  ...
  >
    <v-list nav>
      ...
      <v-list-item v-if="featureFlagStore.isEnabled('notifications')" title="Notifications" to="/notifications" prepend-icon="mdi-bell"></v-list-item>
