<template>
  ...
  >
    <v-list nav>
      ...
      <v-list-item v-if="featureFlagStore.isEnabled('agent')" title="AI Agent" to="/agent" prepend-icon="mdi-robot"></v-list-item>
      ...
      <v-list-item v-if="featureFlagStore.isEnabled('notifications')" title="Notifications" to="/notifications"></v-list-item>
      ...
      <v-list-item title="Subgraphs Dashboard" to="/subgraphs"></v-list-item>
    </v-list>
  </v-navigation-drawer>
</template>
