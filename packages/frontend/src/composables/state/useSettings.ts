...
const DEFAULT_SUBGRAPH_COLUMNS: ColumnSetting[] = [
  ...
  { id: 'dailyRewards', title: 'Est Daily Rewards', visible: true },
  { id: 'dailyRewardsCut', title: 'Est Daily Rewards (After Cut)', visible: true },
  { id: 'signalledTokens', title: 'Current Signal', visible: true },
  { id: 'proportion', title: 'Current Proportion', visible: true },
  { id: 'stakedTokens', title: 'Current Allocations', visible: true },
...
const DEFAULT_ALLOCATION_COLUMNS: ColumnSetting[] = [
  ...
  { id: 'dailyRewards', title: 'Est Daily Rewards', visible: true },
  { id: 'dailyRewardsCut', title: 'Est Daily Rewards (After Cut)', visible: true },
  { id: 'pendingRewards', title: 'Pending Rewards', visible: true },
  { id: 'pendingRewardsCut', title: 'Pending Rewards (After Cut)', visible: true },
  { id: 'signalledTokens', title: 'Current Signal', visible: true },
  { id: 'proportion', title: 'Current Proportion', visible: true },
  { id: 'stakedTokens', title: 'Current Allocations', visible: true },
  { id: 'deploymentId', title: 'Deployment ID', visible: true },
  { id: 'allocationId', title: 'Allocation ID', visible: true },
